# -*- coding: utf-8 -*-
"""Data_preparation_V2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16v-y9Sc-PPnDT-_mkLY5OFEADyVdlxfU
"""
...
if __name__ == "__main__":
    ...
    print("Selected Target Columns:", target_columns)
    ...
    # Display results
    print("\nTrain set head (standardized):")
    print(train.head())
    print("\nValidation set head (standardized):")
    print(val.head())
    print("\nTest set head (standardized):")
    print(test.head())

    # Print the sizes of each set
    print(f"\nTrain set size: {len(train)} rows")
    print(f"Validation set size: {len(val)} rows")
    print(f"Test set size: {len(test)} rows")

    # Verify the standardization of training features
    print("\nTrain feature (post-standardization):")
    print(train[feature_columns].head())
    print("\nTest feature (post-standardization):")
    print(test[feature_columns].head())
    print("\nValidation feature (post-standardization):")
    print(val[feature_columns].head())
